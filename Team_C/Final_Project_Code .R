...
train <- read.csv("~/Desktop/Team_C/Files/train.csv")
test <- read.csv("~/Desktop/Team_C/Files/test.csv")
macro <- read.csv("~/Desktop/Team_C/Files/macro.csv")
sample_submission <- read.csv("~/Desktop/Team_C/Files/sample_submission.csv")
